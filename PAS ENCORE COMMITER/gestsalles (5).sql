...
--
-- Client: 127.0.0.1
-- Généré le: Dim 14 Octobre 2012 à 13:19
...
INSERT INTO `cinema` (`id_cinema`, `nom`, `nb_salles`, `id_adr`) VALUES
('cin01', 'cinema1', 10, 'adr01'),
('cin02', 'cinema2', 8, 'adr02'),
('cin03', 'cinema3', 13, 'adr03'),
('cin04', 'cinema4', 8, 'adr05'),
('cin05', 'cinema5', 4, 'adr04');
...
INSERT INTO `films` (`id_film`, `titre`, `duree`, `Catégorie`, `Description`, `Edition`, `id_cinema`) VALUES
('film01', 'Devil Inside', 2, 'Horreur, Thriller', 'Le film «Sia le rêve du python» est une adaptation cinématographique de la légende du Wagadu (mythe Soninké du 7e siècle). Inspiré de la pièce de théâtre «La légende du Wagadu vue par Sia Yatabéré» de l´auteur mauritanien Moussa Diagana, le film est une approche politique universelle et contemporaine du mythe, une réflexion sur l''utilisation du mystère par le pouvoir.', '2012', 'cin01'),
('film02', 'Contraband', 3, 'Drame, Thriller', 'est un film de science-fiction de James Cameron tourné en 3D Relief, sorti en France le 16 décembre 2009. L''action se déroule sur la lune d''une géante gazeuse, Pandora, recouverte d''une jungle luxuriante', '2011', 'cin02'),
('film03', 'Dos au mur', 2, 'Crime, Thriller', 'Un programme est créé par les terriens, le programme Avatar qui va leur permettre de contrôler des corps Na''vi clonés associés à des gènes humains, afin de s''insérer dans la population et de tenter de négocier avec elle, dans la mesure où le clan', '2012', 'cin03'),
('film04', 'The Divide', 3, 'Science-Fiction, Thriller, Action', 'Il a été tourné entre le mois d''août et le mois de septembre 1999 au Burkina Faso, dans la région de Ouagadougou (Kokologho) pour les extérieurs du Palais et pour le reste à Bobo-Dioulasso notamment dans le vieux quartier de Dioulassoba et dans les environs de cette ville.', '2012', 'cin04'),
('film05', '13 Flowers of Nanjing', 2, 'action', 'Description du film DILA. Introduction - La DILA; La diffusion de la norme juridique française; La garantie de la transparence économique et financière', '2011', 'cin05');
...
INSERT INTO `projections` (`id_proj`, `horaire`, `durée_proj`, `Date`, `Prix`, `id_film`, `id_salle`) VALUES
('proj01', '10:00', 2, '0000-00-00', 3, 'film01', 'sal01'),
('proj02', '12:00', 2, '0000-00-00', 6, 'film02', 'sal02'),
('proj03', '15:00', 3, '0000-00-00', 4, 'film03', 'sal05'),
('proj04', '18:00', 3, '0000-00-00', 8, 'film04', 'sal06'),
('proj05', '20:00', 2, '0000-00-00', 10, 'film05', 'sal07');
